...
namespace common
{
    public class MarcHelper
    {
        ...
        public static string SetFields(string strMarcWorksheet, List<FieldItem> list)
        {
        ...
        public static string SetFields(string strMarcWorksheet, string strFieldMap)
        {
            List<FieldItem> fieldList = MarcHelper.ParseFieldMap(strFieldMap);
            return SetFields(strMarcWorksheet, fieldList);
        }
